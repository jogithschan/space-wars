...
def handle_yellow_movement(keys_pressed, yellow):
    if keys_pressed[pygame.K_a] and yellow.x - VELOCITY > 0:  #left
        yellow.x -= VELOCITY
    if keys_pressed[pygame.K_d] and yellow.x + VELOCITY < (
            WIDTH / 2) - SSW + 15:  #right
        yellow.x += VELOCITY
    if keys_pressed[pygame.K_w] and yellow.y - VELOCITY > 0:  #up
        yellow.y -= VELOCITY
    if keys_pressed[
            pygame.K_s] and yellow.y + VELOCITY < HEIGHT - SSH - 15:  #down
        yellow.y += VELOCITY
...
def handle_red_movement(keys_pressed, red):
    ...
    if keys_pressed[pygame.K_UP] and red.y - VELOCITY > 0:  #up
        red.y -= VELOCITY
    if keys_pressed[
            pygame.K_DOWN] and red.y + VELOCITY < HEIGHT - SSH - 15:  #down
        red.y += VELOCITY
...
def main():
    BACKGROUND_MUSIC.play(loops=0, fade_ms=0)
